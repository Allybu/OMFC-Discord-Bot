...
module.exports = {
    ...
    execute(msg, args) {
        ...
        .addField("/list", "Gibt eine Liste aller Spiele mit dazugehörigem Kürzel aus.")
        ...
        .addField("/play KÜRZEL TEXT", "Startet ein Voting für das angegebene Spiel mit eigenem Text.")
