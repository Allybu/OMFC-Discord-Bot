...
module.exports = {
    ...
    execute(msg, args) {
        ...
        if (args[0]) {
            ...
            axios
                .get(
                    `https://raider.io/api/v1/characters/profile?region=EU&realm=malygos&name=${args[0]}&fields=gear,guild,raid_progression,mythic_plus_ranks,mythic_plus_scores_by_season:current`
                )
                .then((response) => {
                    const { data } = response;
                    ...
                    */
                    ...
                    const raidSummery =
                        data.raid_progression['castle-nathria'].summary;
                    ...
                    const embed = new Discord.MessageEmbed()
                        ...
                        .addField(
                            'Score',
                            `Mythic+ Score: ${mythicScore}, Castle Nathria: ${raidSummery}`
                        )
